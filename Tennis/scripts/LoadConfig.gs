...
function getGlobalConfigObject() {
  ...
  globalConfig.MIN_TEAM_MEMBERS = getNumConfig("MIN_TEAM_MEMBERS", 4);
  ...
  globalConfig.UPDATED_INVALID_MESSAGE = getStrConfig("UPDATED_INVALID_MESSAGE", '<div style="margin-bottom: 20px;">THE BELOW WEEKS NEED CORRECTION! There are either too many players allocated or too few.</div>');
  ...
  globalConfig.REMINDER_PREVIEW_WEEKS = getNumConfig("REMINDER_PREVIEW_WEEKS", 3);
